...
Route::group(['prefix' => 'admin', 'middleware' => ['loggin', 'system']], function () {
    ...
    Route::get('planillas', [PlanillaController::class, 'index'])->name('voyager.planillas.index');
    Route::get('planillas/ajax/list', [PlanillaController::class, 'list']);
    ...
    Route::get('reportes/planillas', [ReporteController::class, 'indexPlanilla'])->name('reportes-planillas.index');
    Route::post('reportes/planillas/list', [ReporteController::class, 'listPlanilla'])->name('reportes-planillas.list');
